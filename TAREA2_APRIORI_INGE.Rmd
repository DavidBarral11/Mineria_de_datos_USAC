...
datos_lfa_gt <- subset(datos_gt, CARRERA == "Licenciatura en Fisica")
data.frame(1:ncol(datos_lfa_gt), colnames(datos_lfa_gt))
reglas_lfa_gt <- apriori(datos_lfa_gt, parameter = list(support=0.2, confidence = 0.5)) 
inspect(reglas_lfa_gt[0:40])
...
datos_lfa_rest <- subset(datos_resto, CARRERA == "Licenciatura en Física")
data.frame(1:ncol(datos_lfa_rest), colnames(datos_lfa_rest))
reglas_lfa_rest <- apriori(datos_lfa_rest, parameter = list(support=0.2, confidence = 0.5)) 
inspect(reglas_lfa_rest[0:40])
